...
privileged aspect CustomerDataOnDemand_Roo_DataOnDemand {
    ...
    public Customer CustomerDataOnDemand.getNewTransientCustomer(int index) {
        ...
        setCustomers_ID(obj, index);
        setCustomers_Name(obj, index);
        return obj;
    }
    
    public void CustomerDataOnDemand.setCustomers_ID(Customer obj, int index) {
        String Customers_ID = "Customers_ID_" + index;
        obj.setCustomers_ID(Customers_ID);
    }
    
    public void CustomerDataOnDemand.setCustomers_Name(Customer obj, int index) {
        String Customers_Name = "Customers_Name_" + index;
        obj.setCustomers_Name(Customers_Name);
    }
